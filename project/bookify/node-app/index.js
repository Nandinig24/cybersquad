...
// mongoose.connect('mongodb+srv://nandini:12345@cluster0.jjfejno.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')

mongoose.connect('YOUR_MONGOSSE_URL');
app.get('/', (req, res) => {
    res.send('hello...')
})
